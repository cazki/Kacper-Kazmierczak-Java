...
@SpringBootTest(classes = InvoiceDao.class)
public class InvoiceDaoTestSuite {
    ...
    public void testInvoiceDaoSave() {
        //Given
        Invoice invoice = new Invoice("253/12/2019");

        Product bread = new Product("bread");
        Product butter = new Product("butter");
        Product knife = new Product("knife");

        Item itemBread = new Item(bread, new BigDecimal(3), 2);
        Item itemButter = new Item(butter, new BigDecimal(8), 1);
        Item itemKnife = new Item(knife, new BigDecimal(115), 1);
