...
public class TaskFactoryTestSuite {
    ...
    public void testMakeShoppingTask() {
        ...
        //When
        Task shopping = taskFactory.makeTask(TaskFactory.SHOPPING, "My shopping list", "potatoes", "2.5");
    ...
    public void testMakePaintingTask() {
        ...
        TaskFactory taskFactory = new TaskFactory();
        //When
        Task painting = taskFactory.makeTask(TaskFactory.PAINTING, "My painting task", "blue", "my car");
    ...
    public void testMakeDrivingTask() {
        ...
        TaskFactory taskFactory = new TaskFactory();
        //When
        Task driving = taskFactory.makeTask(TaskFactory.DRIVING, "My driving task", "to heaven", "my painted blue car");
    ...
    public void testNullTask(){
        ...
        TaskFactory taskFactory = new TaskFactory();
        //When
        Task nullTask = taskFactory.makeTask("Null", "My null task", "", "");
        //Then
